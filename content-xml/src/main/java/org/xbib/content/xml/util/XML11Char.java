...
public class XML11Char {
     ...
     * @return true if character is valid names start character
     */
     ...
     *
     * @param c The character to check.
     * @return true if character is valid name character
     */
     ...
     *
     * @param c The character to check.
     * @return true if character is valid namespace classified name start character
     */
     ...
     *
     * @param c The character to check.
     * @return true if character is valid namespace classified name character
     */
     ...
     *
     * @param c The character to check.
     * @return true if character is valid high surrogate
     */
     ...
     * @return true if name is a valid XML Name
     */
    public static boolean isXML11ValidName(String name) {
        ...
        if (!isXML11NameStart(ch)) {
            if (length > 1 && isXML11NameHighSurrogate(ch)) {
                ...
                if (!isLowSurrogate(ch2) || !isXML11NameStart(supplemental(ch, ch2))) {
                    return false;
                }
                i = 2;
            } else {
            ...
            if (!isXML11Name(ch)) {
                if (++i < length && isXML11NameHighSurrogate(ch)) {
                    ...
                    if (!isLowSurrogate(ch2) ||
                            !isXML11Name(supplemental(ch, ch2))) {
                        return false;
                    }
                } else {
                    return false;
     ...
     *
     * @param c The character to check.
     * @return true if character is low surrogate
     */
